...
from .models import normalize_cefr_level
...
PROFILE_SYSTEM_PROMPT = (
    ...
    "years_of_experience (a number of years of relevant experience; use a "
    "decimal such as 0.2, 0.3, 0.5 or 0.8 when the candidate has less than one "
    "full year; whole numbers for a year or more; or null if truly unknown), "
